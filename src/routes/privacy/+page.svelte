	...
	<div class="space-y-8 text-sm leading-relaxed text-text-secondary">
		...
		<div>
			...
			<ul class="ml-4 list-disc space-y-1">
				<li>
					<strong>Account Information:</strong> Name, email address, and phone number (optional) provided
					during registration.
				</li>
				<li>
				...
				<li>
					<strong>Communication Data:</strong> Email addresses and phone numbers used to send notifications
		...
		<div>
			...
			<p>
				...
				connections (TLS/SSL), secure authentication, and access controls. However, no method of
		...
		<div>
			...
			<p>
				Forbetra is not intended for users under the age of 18. We do not knowingly collect personal

...
<SignedOut>
	<section class="flex min-h-screen w-full flex-col bg-[#F9FAFB] md:flex-row">
		<div class="flex w-full flex-col justify-center bg-gradient-to-br from-[#F8FAFC] via-[#F1F5F9] to-[#E2E8F0] px-8 py-16 md:w-1/2">
